...
public final class ReaderStringContract {
    ...
    public static void main(String[] args) {
        ...
        require(exprEntry.cdr instanceof Value.StringValue,
                "expr value must be a language StringValue, got " + exprEntry.cdr.getClass().getName());
        ...
        require(escaped instanceof Value.StringValue, "escaped literal must be language StringValue");
