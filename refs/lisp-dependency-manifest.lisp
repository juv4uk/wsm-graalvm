...
;;
;; The current main line already proves the Truffle frame and Tier-1 inventory
;; gates. This manifest therefore stays orthogonal: it records which upstream
;; Lisp sources are intentionally admitted to the bootstrap boundary.
