...
"\$HERE/lib/wsm-graalvm/$RELEASE_VERSION/native-wsm" \
  "\$AUTH/lib/canon.lisp" "\$AUTH/lib/macro.lisp" "\$AUTH/lib/core.lisp" \
  "\$SOURCE" "\$AUTH/lib/surface/semantic-registry.lisp" "\$HERE"
EOF
  chmod +x "$OUT/bin/wsm"
else
