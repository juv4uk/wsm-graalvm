...
PAYLOAD=$2
OUT=$3
[ "$#" -eq 3 ] || { echo "usage: package-rpm.sh VERSION PAYLOAD_DIR OUTPUT_DIR" >&2; exit 2; }
...
cp "$ROOT/RPMS/x86_64/"*.rpm "$OUT/wsm-graalvm-$PKG_VERSION-linux-x86_64.rpm"
echo "RPM-OK $OUT/wsm-graalvm-$PKG_VERSION-linux-x86_64.rpm"
